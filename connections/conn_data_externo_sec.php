<?php
require_once $dir_fc."connections/conn_config_externo_sec.php";
...
class BDS
{
	...
	{
		try {
			$this->_dbHost_ex = DB_HOST_EX_SEC;
			$this->_dbUser_ex = DB_USER_EX_SEC;
			$this->_dbPassword_ex = DB_PASS_EX_SEC;
			$this->_dbName_ex = DB_NAME_EX_SEC;
